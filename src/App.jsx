...
const resources = [
  ...
  {type:'HEALTHCARE', title:'HHS HIPAA Security Rule', text:'Official HHS guidance for administrative, physical, and technical safeguards protecting electronic protected health information.', url:'https://www.hhs.gov/hipaa/for-professionals/security/index.html'},
  {type:'CRIMINAL JUSTICE', title:'FBI CJIS Security Policy Resource Center', text:'The current CJIS Security Policy and supporting resources for protecting criminal justice information.', url:'https://www.fbi.gov/services/cjis/cjis-security-policy-resource-center'},
  {type:'PAYMENT DATA', title:'PCI SSC Document Library', text:'Current PCI Security Standards Council publications, including the active PCI DSS revision and supporting guidance.', url:'https://www.pcisecuritystandards.org/document_library/'},
...
function Header(){
  ...
  const links=[['Doctrine','/doctrine.html'],['OICC Controls','/controls.html'],['Standards','/standards.html'],['Industries','/industries.html'],['Evidence','/evidence.html'],['Resources','/resources.html'],['Tools','/tools.html'],['About','/about.html']]
...
function App(){
  ...
  <section className="section tools" id="tools" data-page="tools">
    <div className="section-number">09 / IMPLEMENTATION TOOLS</div>
  ...
  <section className="section about" id="about" data-page="about">
    <div className="section-number">10 / ABOUT OSI</div>
